 ...
 */
export declare function isSubsetOf(set: Set): (notes: Set | Pcset) => boolean | 0;
/**
 * Create a function that test if a collection of notes is a
 ...
 */
export declare function isNoteIncludedIn(set: Set): (noteName: NoteName) => boolean;
 ...
 */
export declare function filter(set: Set): (notes: NoteName[]) => string[];
