 ...
 */
export declare function get(type: ScaleTypeName): ScaleType;
export declare const scaleType: (this: unknown, ...args: unknown[]) => ScaleType;
/**
 * Return a list of all scale types
 */
export declare function all(): ScaleType[];
export declare const entries: (this: unknown, ...args: unknown[]) => ScaleType[];
/**
